...
const arrowCloseCarritoNavbar = document.querySelector('.title-container img');
arrowCloseCarritoNavbar.addEventListener('click', closeCarritoNavbarArrow);

function closeCarritoNavbarArrow(){
...
for(product of array){
    ...
    productImg.addEventListener('click', openProductDetailAside);//dispara el detalle del producto cuando se le da click a la imagen en la pantalla de productos
...
function openProductDetailAside(){
    const iscontenidoCarrtitoNavbarClosed = contenidoCarrtitoNavbar.classList.contains('inactive');
